...
function bof_material_card_styles() {
    ...
    @media(max-width:600px){.bof-material-card-section{width:92vw;margin-top:3rem;margin-bottom:4rem}.bof-material-card-grid{grid-template-columns:1fr;gap:14px}.bof-material-card{min-height:230px}}
    ';
